...
public class RemarkedValueTransformTest {
	...
	public static void setUpClass() {
		...
		inputSampleDataset = ResultSetUtils.createTableRows(inputColumns, new String[][] {
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1979-12-31T18:00:00.000-06:00","<1.143605947"},
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1980-12-31T18:00:00.000-06:00",">4585894.2"},
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1981-12-31T18:00:00.000-06:00","<7674767.59"},
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1982-12-31T18:00:00.000-06:00","8882042.96"},
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1983-12-31T18:00:00.000-06:00","1.325656857"},
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1984-12-31T18:00:00.000-06:00","5864574.53"},
			new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1985-12-31T18:00:00.000-06:00","<8600366.26"}
		});
		...
		expectedSampleRemarksDataset = ResultSetUtils.createTableRows(inputColumns, new String[][] {
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1979-12-31T18:00:00.000-06:00","<"},
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1980-12-31T18:00:00.000-06:00",">"},
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1981-12-31T18:00:00.000-06:00","<"},
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1982-12-31T18:00:00.000-06:00",""},
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1983-12-31T18:00:00.000-06:00",""},
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1984-12-31T18:00:00.000-06:00",""},
				new String[] {"01646580","http://cida.usgs.gov/def/NAR/property/TN","annual_flow","1985-12-31T18:00:00.000-06:00","<"}
		});
	}
