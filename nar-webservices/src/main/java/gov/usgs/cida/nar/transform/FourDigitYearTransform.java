 ...
 * @author thongsav
 */
public class FourDigitYearTransform implements ColumnTransform {
	private static final Logger log = LoggerFactory.getLogger(FourDigitYearTransform.class);

	protected final Column inColumn;

	public FourDigitYearTransform(Column inColumn) {
