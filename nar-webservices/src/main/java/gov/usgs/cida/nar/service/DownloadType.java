...
public enum DownloadType {
	annualLoad("Annual loads", 
			Arrays.asList(
					...
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/COMP",
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/DAILY",
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/REG",
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/REGHIST",
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/REG_3",
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/REG_PRELIM",
					"http://cida.usgs.gov/def/NAR/procedure/annual_concentration_mean/REG_PRELIM_FINAL",
